...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/myamigo1214/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/myamigo1214/edx-platform.git
PLATFORM_VERSION=oxa/master.fic
THEME_REPO=https://github.com/myamigo1214/edx-theme.git
